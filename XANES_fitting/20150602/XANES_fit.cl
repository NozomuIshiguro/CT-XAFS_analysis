...
#ifndef MT_DEF
#define MT_DEF __global float *mt_N0,__global float * __local *mt_p
#endif

#ifndef MT_P
#define MT_P mt_p[0]=mt_N0
#endif

#ifndef FIT_RESULTS_DEF
#define FIT_RESULTS_DEF __global float *fit_results_img_N0,__global float * __local *fit_results_p
#endif

#ifndef FIT_RESULTS_P
#define FIT_RESULTS_P fit_results_p[0]=fit_results_img_N0
#endif
...
#ifndef INITIAL_FX_OLD(x,fx,fp,mt)
#define INITIAL_FX_OLD(x,fx,fp,mt){\
\
float a_X = ((x)-((float*)(fp))[3])/((float*)(fp))[4];\
float l_X = ((x)-((float*)(fp))[6])/((float*)(fp))[7];\
\
...
#ifndef MT_DATA_READ(pmem,id)
#define MT_DATA_READ(pmem,id){\
\
((float*)(pmem))[0]=mt_N0[(id)];\
\
}
#endif

#ifndef FIT_RESULTS_WRITE(pmem,id)
#define FIT_RESULTS_WRITE(pmem,id){\
\
fit_results_img_N0[(id)]=((float*)(pmem))[0];\
\
}
#endif
