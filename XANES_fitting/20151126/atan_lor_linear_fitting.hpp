...
const string atanlorlinear_preprocessor1 = "#define FIT(x,mt,fp,dp){\\\n\
\\\n\
float a_X = ((x)-(((float*)(fp))[3]+((float*)(dp))[3]))/(((float*)(fp))[4]+((float*)(dp))[4]);\\\n\
float l_X = ((x)-(((float*)(fp))[6]+((float*)(dp))[6]))/(((float*)(fp))[7]+((float*)(dp))[7]);\\\n\
\\\n\
...
const string atanlorlinear_preprocessor2 = "#define JACOBIAN(x,j,fp){\\\n\
\\\n\
