...
//reduction
#ifndef REDUCTION
#define REDUCTION(l,rp) reduction((__local float*)(l),(__local float*)(rp),(3));
#endif


//calculate delta_transpara
#ifndef CALC_DELTA_TRANSPARA
...
\
(dr) = (((__local float*)(dtp))[0]*((l)*((__local float*)(dtp))[0]-((__local float*)(rp))[2]))/2.0;\
}\
barrier(CLK_LOCAL_MEM_FENCE);\
}
#endif
...
#ifndef TRANSPARA_ERR_GLOB_COPY
#define TRANSPARA_ERR_GLOB_COPY(rp,tp_err,lid,gid){\
if((lid)==0){\
((__global float*)(tp_err))[gid]=0.5/fabs(((__local float*)(rp))[1]);\
}\
barrier(CLK_LOCAL_MEM_FENCE|CLK_GLOBAL_MEM_FENCE);\
}
#endif
