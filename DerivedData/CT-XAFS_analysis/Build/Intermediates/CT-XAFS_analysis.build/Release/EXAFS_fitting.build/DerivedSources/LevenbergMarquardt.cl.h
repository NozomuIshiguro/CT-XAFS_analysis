...
extern void (^ISTA_kernel)(const cl_ndrange *ndrange, cl_float* fp_img, cl_float* dp_img, cl_float* tJJ_img, cl_float* tJdF_img, cl_char* p_fix, cl_float* lambda_LM, cl_float* lambda_fista);
extern void (^FISTA_kernel)(const cl_ndrange *ndrange, cl_float* fp_img, cl_float* dp_x_img, cl_float* dp_w_img, cl_float* tJJ_img, cl_float* tJdF_img, cl_char* p_fix, cl_float* lambda_LM, cl_float* lambda_fista, cl_float* beta_img);
