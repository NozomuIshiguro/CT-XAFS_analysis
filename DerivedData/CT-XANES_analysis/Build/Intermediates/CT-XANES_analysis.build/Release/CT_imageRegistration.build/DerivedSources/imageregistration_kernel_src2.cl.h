...
extern void (^imageRegistration1_kernel)(const cl_ndrange *ndrange, cl_image mt_t_img, cl_image mt_s_img, cl_float* p, cl_float* p_target, cl_float* dF2, cl_float* tJdF, cl_float* tJJ, cl_int mergeN, size_t loc_mem);
extern void (^imageRegistration2_kernel)(const cl_ndrange *ndrange, cl_image mt_t_img, cl_image mt_s_img, cl_float* p, cl_float* p_target, cl_float* dF2, cl_int mergeN, size_t loc_mem);
extern void (^estimateParaError_kernel)(const cl_ndrange *ndrange, cl_float* p_error, cl_float* tJJ);
